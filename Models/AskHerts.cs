...
namespace Luis
{
    public partial class AskHerts : IRecognizerConvert
    {
        [JsonProperty("text")]
        public string Text;
        ...
        public class _Entities
        {
            ...
            public class _Instance
            {
                ...
                public InstanceData[] letter_type;
                public InstanceData[] professor;
                public InstanceData[] purpose;
            }
        ...
        {
            var app = JsonConvert.DeserializeObject<AskHerts>(
